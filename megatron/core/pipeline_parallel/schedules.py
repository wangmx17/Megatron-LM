...
def forward_step_calc_loss(
    ...
    #     config.timers('forward-compute-loss-calc', log_level=2).start()
    ...
    # if config.timers is not None:
    #     config.timers('forward-compute-loss-calc').stop()
...
def forward_step(
    ...
    # if config.timers is not None:
    #     config.timers('forward-compute-set-input', log_level=2).start()
    ...
    # if config.timers is not None:
    #     config.timers('forward-compute-set-input').stop()

    # if config.timers is not None:
    #     config.timers('forward-compute-model-forward', log_level=2).start()
    ...
    # if config.timers is not None:
    #     config.timers('forward-compute-model-forward').stop()
