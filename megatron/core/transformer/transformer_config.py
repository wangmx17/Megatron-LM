...
class TransformerConfig(ModelParallelConfig):
    ...
    # logging option
    ####################
    log_hidden_rms_interval: int = None
    log_max_attention_logit_interval: int = None
    ...
    """If True, use Triton RoPE THD kernel instead of TE fused kernel."""
    ...
    moe_expert_health_monitoring: bool = False
    """Enable expert health monitoring for MoE. Tracks per-expert activation norms,
    max-to-median ratio (detects localized activation blow-up), min-to-median ratio
    (detects expert collapse), and routing confidence. Logging cadence follows
    --log-task-loss-interval. Reference: Step 3.5 Flash
