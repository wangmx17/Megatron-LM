...
class TransformerLayer(GraphableMegatronModule, BaseTransformerLayer):
    ...
    def forward(self, *args, **kwargs):
        ...
        # monitor
        if StatesLoggingHelper.should_log_hidden_rms:
            StatesLoggingHelper.save_attn_hidden_rms_to_tracker(hidden_states, self.layer_number)
            StatesLoggingHelper.save_mlp_hidden_rms_to_tracker(output, self.layer_number)
        # if StatesLoggingHelper.should_log_attention_max_logit and max_attn_logit is not None:
        #     StatesLoggingHelper.save_max_attention_logit_to_tracker(max_attn_logit, self.layer_number)
    ...
    def _forward_attention(
        ...
        *,
        ...
        # max_attn_logit = attention_output_with_bias[2]
        # attention_output_with_bias = (attention_output_with_bias[0], attention_output_with_bias[1])
