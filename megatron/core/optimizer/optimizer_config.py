...
class MuonOptimizerConfig(OptimizerConfig):
    ...
    """ whether use nesterov momentum """

    muon_ns_steps: int = 5
    """The adamw update rms that muon is designed to matched, typicially 0.2 ~ 0.4"""

    muon_matched_adamw_rms: float = 0.2
    """ scaler that matches muon update rms with adamw """

    muon_split_qkv: bool = False
    """ whether split qkv for ns iteration """

    muon_coefficient_type: str = "simple"
    """ which coefficient type to use """